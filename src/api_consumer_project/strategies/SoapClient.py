        ...
        """
            ...
            Args:
                endpoint (str | None):
                    ...
                    Se None, a operação é abortada e uma resposta de erro é retornada.
            ...
            Returns:
                ResponseModel:
                    ...
                    - "status_code": valor HTTP simbólico (200 para sucesso, 400/500 para falhas).
            ...
            Raises:
                ...
                Em caso de falha, um "ResponseModel" com "success=False" é retornado.
        """
        try:
            if endpoint is None:
